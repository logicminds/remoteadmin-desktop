package 
{
	...
	public class remoteadmin_desktopMediator extends ViewMediatorBase
	{
		[Inject] public var preferences:AppPreferences;
		[Inject] public var view:remoteadmin_desktop
		[Inject] public var menu:Menus;
		
		public function remoteadmin_desktopMediator()
		{
			super();
